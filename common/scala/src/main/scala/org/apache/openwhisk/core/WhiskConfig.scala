...
object ConfigKeys {
  ...
  val actionInvokesPerTimeFrame = "whisk.timeFrame-limit"
  val actionInvokesTimeFrame = "whisk.timeFrame-interval"

  // start self defined variables

  val storageLimit = "whisk.bid-storage-limit"

  val storageLimits = "whisk.bid-storage-limits"

  val nodeStorageLimit = "whisk.node-storage-limit"

  val nodeID = "whisk.node-id"

  val nextNode = "whisk.next-node"
