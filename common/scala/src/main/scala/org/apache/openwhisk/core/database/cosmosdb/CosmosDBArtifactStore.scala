...
class CosmosDBArtifactStore[DocumentAbstraction <: DocumentSerializer](protected val collName: String,
  ...
  override protected[database] def getDBStats()(implicit transid: TransactionId): Future[BigInt] = ???
  // TODO
  override protected[database] def findWithLowerStorageBid(bid: Double)(implicit transid: TransactionId): Future[DocInfo] = ???
  // TODO
  override protected[database] def createIndexOnStorageBid()(implicit transid: TransactionId): Future[String] = ???
}
